...
const KNOWN_LIMITATIONS = [
  ...
  "Provider status polling for '429 with Retry-After' and '500 provider error' verifies that an accepted submission remains awaiting confirmation with its provider receipt preserved; the worker confirmation pass rechecks that receipt and never re-submits the post.",
