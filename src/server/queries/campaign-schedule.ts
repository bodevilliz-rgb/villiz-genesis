...
export async function getCampaignSchedule(campaignId: string, client?: ReturnType<typeof createAdminClient>): Promise<CampaignScheduleSlotView[]> {
  const db = (client ?? createAdminClient()) as unknown as Reader;
